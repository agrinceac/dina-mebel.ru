...
class Settings extends Model
{
	...
	public function rules()
	{
		return array(
			...
			'admin_email' => array(
				'validation' => array('_validMultiEmails',  array('notEmpty'=>true, 'key'=>'admin_email')),
				'adapt' => '_adaptChangeName'
			),
			'bcc_email' => array(
				'validation' => array('_validEmail',  array('notEmpty'=>true, 'key'=>'bcc_email')),
				'adapt' => '_adaptChangeName'
			),
			'noreply_email, rate' => array(
				'adapt' => '_adaptChangeName'
			),
			'metaTitle, metaKeywords, metaDescription' => array(
				'adapt' => '_adaptChangeName'
			)
		);
	}
