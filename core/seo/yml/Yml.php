...
class Yml
{
	...
	public function addCategories(\core\modules\categories\Categories $categories)
	{
	...
	private function addCategory(\core\modules\categories\Category $category)
	{
	...
	{
		$sitemap = '<shop><name>'.\core\Configurator::getInstance()->ymlCompanyName.'</name>'
			.'<company>'.\core\Configurator::getInstance()->ymlShopName.'</company>'
			.'<url>'.$this->domain.'/</url>'
