				...
				<div class="action_buts">
					...
					<? if ($object->id):?>
						<a class="button confirm pointer" data-confirm= "Remove the good?" data-action="/admin/goods/remove/<?=$object->id?>/"
							data-callback="postRemoveFromDetails" data-post-action="/admin/goods/goods/" >
							<img src="/admin/images/buttons/delete.png" alt="" /> Удалить
						</a>
					<? endif;?>
					<a href="/admin/goods/categories/"><img src="/admin/images/buttons/back.png" alt="" /> Вернуться</a>
				</div>
				<p class="speedbar"><a href="/admin/">Главная</a>     <span>></span>
					<a href="/admin/goods/">Товары</a>    <span>></span>
					<a href="/admin/goods/categories/">Категории</a>    <span>></span>
					<?= $object->id ? $object->name: 'Добавление'?>
				</p>
				<div class="clear"></div>
				<form class="form<?=($object->id)?'Edit':'AddCategory'?>" action="/admin/goods/category<?=($object->id)?'Edit':'Add'?>/" method="post" data-post-action="/admin/goods/categories/">
					<div id="tabs">
						<div class="tab_page">
							<ul>
