		...
		<div class="main single">
			<div class="max_width">
				<div class="action_buts">
					<a href="/admin/articles/article/"><img src="/admin/images/buttons/add.png" alt="" /> Создать</a>
					<a class="filters pointer"><img src="/admin/images/buttons/search.png" alt="" /> Фильтрация</a>
					<a href="/admin/articles/categories/"><img src="/admin/images/buttons/folder.png" alt="" /> Категории</a>
				</div>
				...
				<div class="table_edit">
					...
					<table  id="objects-tbl" data-sortUrlAction="/admin/articles/changePriority/?" width="100%">
						<tr>
						...
						<?foreach ($objects as $object):?>
							<tr id="id<?=$object->id?>" class="dblclick" data-url="/admin/articles/article/<?= $object->id?>" data-id="<?= $object->id?>" data-priority="<?= $object->priority?>">
								...
								<td><a href="/admin/articles/article/<?=$object->id?>/" class="pen"></a></td>
								<td><a class="del pointer button confirm" data-confirm="Remove the item?" data-action="/admin/articles/remove/<?=$object->id?>/" data-callback="postRemoveArticle"></a></td>
							</tr>
						<?endforeach?>
					</table>
					<?endif?>
				...
				<div class="action_edit">
					<form id="groupArray" action="/admin/articles/groupActions/" class="groupArray" method="post" data-callback="reloadPage">
						<table>
							<tr>
