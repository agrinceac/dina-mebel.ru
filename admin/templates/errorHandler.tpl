	...
	<head>
		<style>
			body {
				...
				left: 0px;
				padding: 50px;
				background-image: url('/admin/images/bg-blur.png');
			}
			div {
				margin: 10px;
				border-radius: 5px;
				background: 0 0 100px rgba(244, 244, 244, 0.6);
/*				box-shadow: 0 0 100px rgba(244, 244, 244, 0.6) inset, 0 0 5px rgba(0, 0, 0, 0.3);
				-moz-box-shadow: 0 0 100px rgba(244, 244, 244, 0.6) inset, 0 0 5px rgba(0, 0, 0, 0.3);
				-webkit-box-shadow: 0 0 100px rgba(244, 244, 244, 0.6) inset, 0 0 5px rgba(0, 0, 0, 0.3);*/
				width: 98%;
				text-align: center;
				padding: 10px;
				text-shadow: 0 0 1px #000 inset;
				-moz-text-shadow: 0 0 1px #000 inset;
				-webkit-text-shadow: 0 0 1px #000 inset;
			}
			h1 {
				color: #fff;
...
<? if( isset($this->server['HTTP_ACCEPT_CHARSET'])):?>
							<tr>
